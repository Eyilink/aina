...
const HomeComponent = ({
  ...
  const [remarquePopUp,setRemarquePopUp] = useState<boolean>(false);
          ...
          {carryOnSuivi ?
            (!isEditingP2 ?
              ...
              <>
                ...
                <RemarquePopup isVisible={remarquePopUp} onClose={()=>{setRemarquePopUp(false)}} />
